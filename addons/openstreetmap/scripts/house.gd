...
export(Material) var wall_material = preload("res://addons/openstreetmap/materials/mat_building_wall.tres")
export(float,0,85,1) var roof_angle = 20 setget set_roof_angle
export(Material) var roof_material = preload("res://addons/openstreetmap/materials/mat_house_roof.tres")
export(Material) var blah
